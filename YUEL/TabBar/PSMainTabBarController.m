...
//    [self.tabBar setAlpha:0];
    ...
    [self setupChildVc:[[UINavigationController alloc]initWithRootViewController:[[PSMessageViewController alloc] init]] title:@"" imageName:@"home_customization" slectImageName:@"home_customization_highlighted"];
